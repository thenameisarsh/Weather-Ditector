...
const conditiontTxt = document.querySelector('.condition-txt')
...
const apiKey = '6518eae523025a2aa11ffac3804db92e'
...
function getWeatherIcon(id) {
	if (id <= 232) return 'Weather-rain-thunderstorm.svg.png'
	if (id <= 321) return 'drizzel.png'
	if (id <= 531) return 'rain.svg'
	if (id <= 622) return 'snow.svg.png'
	if (id <= 781) return 'atmosphere.png'
	if (id <= 800) return 'clear.png'
	else return 'Weather-few-clouds.svg.png'
...
function updateForecastsItems(weatherData) {
	...
	const dateTaken = new Date(data)   // ✅ use "data"
	const dateOption = {
		day: '2-digit',
		month: 'short'
	}
	...
	// const forecastItem = `
	//     <div class="forcast-item-container">
